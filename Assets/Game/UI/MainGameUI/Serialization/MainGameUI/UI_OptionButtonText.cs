...
namespace MainGameUI {
	public class UI_OptionButtonText : Framework.PageBase<UI_OptionButtonText>
	{
		...
		public TMPro.TextMeshProUGUI TextMeshProUGUI { get => _TextMeshProUGUI ??= UI.GetComponent<TMPro.TextMeshProUGUI>(); }
	}
}
