...
namespace ItemGame {
	public class UI_TransitionalBackground : Framework.PageBase<UI_TransitionalBackground>
	{
		...
		public UnityEngine.Canvas Canvas { get => _Canvas ??= UI.GetComponent<UnityEngine.Canvas>(); }
	}
}
